...
{
  return (__m128){ __a[3], __a[2], ((const float*)__p)[1], ((const float*)__p)[0] };
}

static __inline__ __m128 __attribute__((__always_inline__))
_mm_loadh_pi(__m128 __a, const __m64 *__p)
{
  return (__m128){ ((const float*)__p)[1], ((const float*)__p)[0], __a[1], __a[0] };
}
...
{
  return (__m128){ 0.0f, 0.0f, 0.0f, *__p };
}
...
static __inline__ __m128 __attribute__((__always_inline__))
__internal_not_ps(__m128 __a)
{
  unsigned int __x = 0xFFFFFFFFU;
  return _mm_xor_ps(__a, _mm_set1_ps(*(float*)&__x));
}
...
#define _mm_cmpneq_ps(__a, __b) __internal_not_ps(_mm_cmpeq_ps((__a), (__b)))
#define _mm_cmpneq_ss(__a, __b) __internal_not_ss(_mm_cmpeq_ss((__a), (__b)))
#define _mm_cmpnge_ps(__a, __b) __internal_not_ps(_mm_cmpge_ps((__a), (__b)))
#define _mm_cmpnge_ss(__a, __b) __internal_not_ss(_mm_cmpge_ss((__a), (__b)))
#define _mm_cmpngt_ps(__a, __b) __internal_not_ps(_mm_cmpgt_ps((__a), (__b)))
#define _mm_cmpngt_ss(__a, __b) __internal_not_ss(_mm_cmpgt_ss((__a), (__b)))
#define _mm_cmpnle_ps(__a, __b) __internal_not_ps(_mm_cmple_ps((__a), (__b)))
#define _mm_cmpnle_ss(__a, __b) __internal_not_ss(_mm_cmple_ss((__a), (__b)))
#define _mm_cmpnlt_ps(__a, __b) __internal_not_ps(_mm_cmplt_ps((__a), (__b)))
