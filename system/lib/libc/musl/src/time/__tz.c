...
// XXX Emscripten: index() is a function in strings.h, and used here as a static variable,
// so reroute the name to avoid collision inside this compilation unit.
#define index xxx_index
