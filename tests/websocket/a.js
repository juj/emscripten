...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'a.wast';
  var wasmBinaryFile = 'a.wasm';
  var asmjsCodeFile = 'a.temp.asm.js';
...
// {{PRE_LIBRARY}}
  ...
  function _connect() {
  err('missing function: connect'); abort(-1);
  }

  function _emscripten_init_websocket_to_posix_socket_bridge() {
  err('missing function: emscripten_init_websocket_to_posix_socket_bridge'); abort(-1);
  }

  function _emscripten_thread_sleep() {
  err('missing function: emscripten_thread_sleep'); abort(-1);
  }
  ...
  function _recv() {
  err('missing function: recv'); abort(-1);
  }

   

  function _send() {
  err('missing function: send'); abort(-1);
  }

  function _socket() {
  err('missing function: socket'); abort(-1);
  }
...
Module.asmLibraryArg = { "abort": abort, "assert": assert, "enlargeMemory": enlargeMemory, "getTotalMemory": getTotalMemory, "abortOnCannotGrowMemory": abortOnCannotGrowMemory, "abortStackOverflow": abortStackOverflow, "nullFunc_ii": nullFunc_ii, "nullFunc_iiii": nullFunc_iiii, "invoke_ii": invoke_ii, "invoke_iiii": invoke_iiii, "___lock": ___lock, "___setErrNo": ___setErrNo, "___syscall140": ___syscall140, "___syscall146": ___syscall146, "___syscall54": ___syscall54, "___syscall6": ___syscall6, "___unlock": ___unlock, "__exit": __exit, "__inet_ntop4_raw": __inet_ntop4_raw, "__inet_ntop6_raw": __inet_ntop6_raw, "__inet_pton4_raw": __inet_pton4_raw, "__inet_pton6_raw": __inet_pton6_raw, "__write_sockaddr": __write_sockaddr, "_connect": _connect, "_emscripten_init_websocket_to_posix_socket_bridge": _emscripten_init_websocket_to_posix_socket_bridge, "_emscripten_memcpy_big": _emscripten_memcpy_big, "_emscripten_thread_sleep": _emscripten_thread_sleep, "_emscripten_websocket_get_ready_state": _emscripten_websocket_get_ready_state, "_exit": _exit, "_getaddrinfo": _getaddrinfo, "_recv": _recv, "_send": _send, "_socket": _socket, "flush_NO_FILESYSTEM": flush_NO_FILESYSTEM, "DYNAMICTOP_PTR": DYNAMICTOP_PTR, "tempDoublePtr": tempDoublePtr, "ABORT": ABORT, "STACKTOP": STACKTOP, "STACK_MAX": STACK_MAX };
