var LibraryPThread = {
  ...
  _spawn_thread: function(threadParams) {
    ...
    var global_libc = emscripten_get_global_libc();
    Atomics.store(HEAPU32, (pthread.threadInfoStruct + {{{ C_STRUCTS.pthread.locale }}}) >> 2, global_libc + {{{ C_STRUCTS_libc.global_locale }}});
