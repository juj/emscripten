...
var LibraryGL = {
  ...
  glCompressedTexImage2D: function(target, level, internalFormat, width, height, border, imageSize, data) {
    ...
    if (GL.currentContext.version >= 2) { // WebGL 2 provides new garbage-free entry points to call to WebGL. Use those always when possible.
      GLctx['compressedTexImage2D'](target, level, internalFormat, width, height, border, HEAP8, data, imageSize);
      return;
    }
#endif
  ...
  glCompressedTexImage3D: function(target, level, internalFormat, width, height, depth, border, imageSize, data) {
    GLctx['compressedTexImage3D'](target, level, internalFormat, width, height, depth, border, HEAP8, data, imageSize);
  },
#endif
...
#if USE_WEBGL2
    if (GL.currentContext.version >= 2) { // WebGL 2 provides new garbage-free entry points to call to WebGL. Use those always when possible.
      GLctx['compressedTexSubImage2D'](target, level, xoffset, yoffset, width, height, format, HEAP8, data, imageSize);
      return;
    }
#endif
  ...
  glCompressedTexSubImage3D: function(target, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, data) {
    GLctx['compressedTexSubImage3D'](target, level, xoffset, yoffset, zoffset, width, height, depth, format, HEAP8, data, imageSize);
  },
#endif
...
#if USE_WEBGL2
    if (GL.currentContext.version >= 2) { // WebGL 2 provides new garbage-free entry points to call to WebGL. Use those always when possible.
      GLctx.uniformMatrix2fv(GL.uniforms[location], HEAPF32, value>>2, count*16);
      return;
    }
#endif
...
#if USE_WEBGL2
    if (GL.currentContext.version >= 2) { // WebGL 2 provides new garbage-free entry points to call to WebGL. Use those always when possible.
      GLctx.uniformMatrix3fv(GL.uniforms[location], HEAPF32, value>>2, count*36);
      return;
    }
#endif
...
#if USE_WEBGL2
    if (GL.currentContext.version >= 2) { // WebGL 2 provides new garbage-free entry points to call to WebGL. Use those always when possible.
      GLctx.uniformMatrix4fv(GL.uniforms[location], HEAPF32, value>>2, count*64);
      return;
    }
#endif
...
#endif
    GLctx.uniformMatrix2x3fv(GL.uniforms[location], HEAPF32, value>>2, count*24);
  },
...
#endif
    GLctx.uniformMatrix3x2fv(GL.uniforms[location], HEAPF32, value>>2, count*24);
  },
...
#endif
    GLctx.uniformMatrix2x4fv(GL.uniforms[location], HEAPF32, value>>2, count*32);
  },
...
#endif
    GLctx.uniformMatrix4x2fv(GL.uniforms[location], HEAPF32, value>>2, count*32);
  },
...
#endif
    GLctx.uniformMatrix3x4fv(GL.uniforms[location], HEAPF32, value>>2, count*48);
  },
...
#endif
    GLctx.uniformMatrix4x3fv(GL.uniforms[location], HEAPF32, value>>2, count*48);
  },
#endif
