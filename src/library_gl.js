...
var LibraryGL = {
  ...
  $GL: {
    ...
    // so that the client code can keep using indices.
    populateUniformTable: function(program) {
      ...
      for(var i = 0; i < numUniforms; ++i) {
        ...
        ptable[name] = [u.size, id];//{ size: u.size, id: id };
        GL.uniforms[id] = loc;
//        console.log('In program ' + program + ', ' + 'first uniform ' + name + ' got the location ' + id);
        ...
        for(var j = 1; j < u.size; ++j) {
          ...
          GL.uniforms[id] = loc;
  //        console.log('In program ' + program + ', ' + (i+1) + 'th uniform ' + n + ' got the location ' + id);
        }
      }
    }
  },
