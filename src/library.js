...
LibraryManager.library = {
...
#if TEXTDECODER == 2
  $UTF8ArrayToString__postset: "var UTF8Decoder = new TextDecoder('utf8');",
#else // TEXTDECODER == 2
#if TEXTDECODER
  $UTF8ArrayToString__postset: "var UTF8Decoder = typeof TextDecoder !== 'undefined' ? new TextDecoder('utf8') : undefined;",
#endif // TEXTDECODER
#endif // TEXTDECODER == 2
  ...
  $stringToUTF8Array: function(str, outU8Array, outIdx, maxBytesToWrite) {
...
#if TEXTDECODER == 2
  $UTF16ToString__postset: "var UTF16Decoder = new TextDecoder('utf-16le');",
#endif // TEXTDECODER == 2
#if TEXTDECODER == 1
  $UTF16ToString__postset: "var UTF16Decoder = typeof TextDecoder !== 'undefined' ? new TextDecoder('utf-16le') : undefined;",
#endif // TEXTDECODER

  $UTF16ToString: function(ptr) {
#if ASSERTIONS
  ...
  $stringToNewUTF8__deps: ['malloc', '$lengthBytesUTF8', '$stringToUTF8'],
